...
自定义控件的后缀名为 ascx，以 <%@ Control> 作为标记。以 MyLogin.ascx 为例:
#+begin_src html
  <%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MyLogin.ascx.cs" Inherits="StudentManageSystem_WF.MyLogin" %>
