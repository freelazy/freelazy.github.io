...
- .NET Core
  ...
  + Core:
    ...
    * Entity Framework 多年以来背负了沉重的历史包袱，因此 Core 中将其精简了，并且加入了对非关系型数据库的之处
  ...
  + 2020.11，微软决定，将原本要推出的 .NET Core 3.1 改名为 .NET5，并承诺，
    未来只有一个 .NET 平台，每年将会推出一个新的版本
